    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="">
              <i class="bi bi-circle"></i><span>Edite</span>
            </a>
          </li>
          <!-- <li>
            <a href="">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart"></i><span>Convert PDF</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="">
              <i class="bi bi-circle"></i><span>PDF List</span>
            </a>
          </li>
          <li>
            <a href="">
              <i class="bi bi-circle"></i><span>PDF List 2</span>
            </a>
          </li>
          <li>
            <a href="">
              <i class="bi bi-circle"></i><span>PDF List 3</span>
            </a>
          </li>
        </ul>
      </li><!-- End Charts Nav -->
      ...
      <!-- <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="">
              <i class="bi bi-circle"></i><span>Edite Volv Icons</span>
            </a>
          </li>
          <li>
